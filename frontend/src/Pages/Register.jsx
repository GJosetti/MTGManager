        ...
        <div className="register-container">
            ...
            <div className="left-panel">
                <div className="illustration-content">
                    {/* Logo simulado com brilho no CSS */}
                    <div style={{ marginBottom: '20px' }}>
                        {/* Você pode colocar sua img de logo aqui */}
                    ...
                    <p>
                        Crie sua conta de lojista hoje e comece a gerenciar seu inventário de Magic: The Gathering como um verdadeiro Planeswalker.
                    </p>
